...
module RR
  describe Double do
    ...
    describe "normal methods" do
      ...
      describe "where there are Scenarios with NonTerminal TimesCalledMatchers" do
      ...
      describe "where there are Terminal Scenarios with duplicate Exact Match ArgumentExpectations" do
        it "dispatches to Scenario that have an exact match" do
